...
from vr_env.scene.objects.light import Light
from vr_env.scene.objects.movable_object import MovableObject
from vr_env.scene.objects.switch import Switch
