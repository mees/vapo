...
Here we show a small summary on how to train the affordance model. For a more detailed explanation on the available options,
please refer to the [affordance model documentation](./docs/affordance.md).
